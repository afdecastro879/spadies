...
Agregar la carpeta `bin` a la variable `PATH` del usuario. Para esto, abrir propiedades del sistema (WinKey+Pause), seleccionar "Configuración avanzada del sistema", "Variables de entorno", y luego agregar a la variable `PATH` el valor `C:/Archivos de Programa/apache-maven-3.3.3` separado por un ;
